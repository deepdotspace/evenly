 ...
 *
 * Generouted renders this around all routes. The provider stack mounts here;
 * the *chrome* is owned per-surface, not globally: the public landing renders
 * its own header, and every /app/* route renders inside the Evenly AppShell
 * (the 3-pane desktop / phone layout). There is no global navigation bar.
 */
      ...
      <DeepSpaceAuthProvider>
        <AuthBoot>
          ...
          <div
            ...
            style={{ background: 'var(--ev-paper)', color: 'var(--ev-ink)' }}
          >
